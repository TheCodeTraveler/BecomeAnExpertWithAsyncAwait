...
// Every step is one bug in the Dashboard page's code-behind.
// Its tab in the workshop guide tells you what to fix, and Run() drives your code the way a busy market does, logs what happens,
...
public abstract class WorkshopStep
{
	...
	// What goes wrong in production, and why nobody noticed on a quiet day
	public abstract string Story { get; }

	// How to watch this bug happen on the Dashboard page
