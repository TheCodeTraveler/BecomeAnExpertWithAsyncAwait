...
public sealed class Step4DrainBacklogOnShutdown : WorkshopStep
{
	...
	public override string SeeItInTheApp => "Once Step 3 passes, run the app with dotnet run from a terminal in the TelemetryPipeline project folder, because an IDE's Stop button usually ends the process at once and skips the shutdown this step is about. "
